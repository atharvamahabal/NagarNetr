...
const AboutPage = () => {
  const hierarchy = [
    ...
    { level: 'Mayor of Pune', icon: Landmark },
    ...
    <div className="p-6 max-w-3xl mx-auto space-y-12">
      ...
      <section className="text-center">
        ...
        <p className="text-gray-600">
          NagarNetr is a citizen-first platform designed to bridge the gap between Pune residents and their elected representatives. 
      ...
      <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        ...
        <p className="text-sm text-gray-600 leading-relaxed">
          ...
          While PMC handles large projects, the Nagarsevak has the "Ward Committee Funds" to fix local issues like potholes, streetlights, and drainage immediately.
        </p>
      </section>
        ...
        <table className="w-full text-left text-sm">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              ...
              <th className="p-4 font-bold text-gray-500">PMC Care</th>
            </tr>
          </thead>
      ...
      <div className="text-center pb-12">
        <p className="text-[10px] text-gray-400 uppercase tracking-widest">NagarNetr MVP v1.0 • Pune 2026</p>
      </div>
    </div>
  )
}
